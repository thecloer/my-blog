    ...
    <footer className='flex min-h-20 items-center bg-slate-300 py-2'>
      <div className='container-lg-62rem mx-auto flex flex-col sm:flex-row items-center sm:justify-between gap-y-2'>
        <div className='flex items-baseline flex-wrap justify-center gap-x-3'>
          ...
          <a href='https://github.com/cloer-Choi' target='_blank' rel='noopener noreferrer author' className='text-sm text-slate-600'>
            &copy;cloer-Choi
          </a>
        </div>
        <div className='flex gap-x-3'>
          ...
          <a href='https://www.instagram.com/thecloer/' target='_blank' rel='noreferrer'>
          ...
          <a href='https://www.linkedin.com/in/seokgyu-choi-06189a221/' target='_blank' rel='noreferrer'>
