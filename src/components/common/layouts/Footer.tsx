  ...
  return (
    <footer className='flex min-h-20 items-center bg-slate-300 '>
      <div className='container-lg-62rem mx-auto flex items-center justify-between flex-col my-2 sm:my-0 sm:flex-row sm:justify-between'>
        <div className='flex items-center mb-2 sm:mb-0 flex-wrap justify-center'>
          <Link href='/' passHref>
            <a>
          ...
          <a href='https://github.com/cloer-Choi' target='_blank' rel='noopener noreferrer author' className='text-sm text-slate-600 ml-4'>
            &copy;cloer-Choi
          </a>
        </div>
